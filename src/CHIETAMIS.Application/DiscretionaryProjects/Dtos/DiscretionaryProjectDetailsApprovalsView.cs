...
{
    public class DiscretionaryProjectDetailsApprovalsView
    {
		public int Id { get; set; }
		public string SDL { get; set; }
		public int OrganisationId { get; set; }
		public string Organisation_Name { get; set; }
		public string Organisation_Trade_Name { get; set; }
		...
		public DiscretionaryDetailApproval ApprovalStatus { get; set; }
		public DiscretionaryGECApproval GECStatus { get; set; }
		public DiscretionaryGACApproval GACStatus { get; set; }
