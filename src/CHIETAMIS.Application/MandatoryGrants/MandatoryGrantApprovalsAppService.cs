...
{
    public class MandatoryGrantApprovalsAppService : CHIETAMISAppServiceBase
    {
        ...
        public MandatoryGrantApprovalsAppService(IRepository<MandatoryApplication> mandatoryApplication,
        ...
        public async Task<PagedResultDto<MandHardToFillSummaryView>> GetHTFVacancies(int applicationId)
        {
            var datagrouped = (from h in _htvfRepository.GetAll().Where(a => a.ApplicationId == applicationId)
                               select new
                               {
                                   ...
                                   Number_Of_Vacancies = h.NUMBER_OF_VACANCIES,
                                   Comment = h.Comment,
                                   ApplicationId = applicationId
                               })
                .Where(a => a.ApplicationId == applicationId)
            ...
            foreach (var bio in datagrouped)
            {
                ...
                wf.EC = _htvfRepository.GetAll().Where(a => a.ApplicationId == applicationId && a.OCCUPATION_OR_SPECIALISATION_TITLE == bio.Occupation && a.OCCUPATION_CODE == bio.Occupation_Code && (a.PROVINCE == "Eastern Cape" || a.PROVINCE == "Eastern_Cape")).Sum(a => a.NUMBER_OF_VACANCIES);
                wf.FS = _htvfRepository.GetAll().Where(a => a.ApplicationId == applicationId && a.OCCUPATION_OR_SPECIALISATION_TITLE == bio.Occupation && a.OCCUPATION_CODE == bio.Occupation_Code && (a.PROVINCE == "Free State" || a.PROVINCE == "Free_State")).Sum(a => a.NUMBER_OF_VACANCIES);
                ...
                wf.KZN = _htvfRepository.GetAll().Where(a => a.ApplicationId == applicationId && a.OCCUPATION_OR_SPECIALISATION_TITLE == bio.Occupation && a.OCCUPATION_CODE == bio.Occupation_Code && (a.PROVINCE == "Kwazulu Natal" || a.PROVINCE == "Kwazulu_Natal")).Sum(a => a.NUMBER_OF_VACANCIES);
                ...
                wf.NP = _htvfRepository.GetAll().Where(a => a.ApplicationId == applicationId && a.OCCUPATION_OR_SPECIALISATION_TITLE == bio.Occupation && a.OCCUPATION_CODE == bio.Occupation_Code && (a.PROVINCE == "Northern Province" || a.PROVINCE == "Northern_Province")).Sum(a => a.NUMBER_OF_VACANCIES);
                wf.NW = _htvfRepository.GetAll().Where(a => a.ApplicationId == applicationId && a.OCCUPATION_OR_SPECIALISATION_TITLE == bio.Occupation && a.OCCUPATION_CODE == bio.Occupation_Code && (a.PROVINCE == "North West" || a.PROVINCE == "North_West")).Sum(a => a.NUMBER_OF_VACANCIES);
                wf.WC = _htvfRepository.GetAll().Where(a => a.ApplicationId == applicationId && a.OCCUPATION_OR_SPECIALISATION_TITLE == bio.Occupation && a.OCCUPATION_CODE == bio.Occupation_Code && (a.PROVINCE == "Western Cape" || a.PROVINCE == "Western_Cape")).Sum(a => a.NUMBER_OF_VACANCIES);
                wfv.Add(wf);
            }
        ...
        public async Task<PagedResultDto<MandatoryApplicationsView>> getMandatoryGrantApplicationsLazy(int first, int rows, string SDLNoFilter, string SDLNoFilterMode, string OrganisationNameFilter, string OrganisationNameFilterMode, string ReferenceFilter, string ReferenceFilterMode, string GrantStatusFilter, string GrantStatusFilterMode, string ProvinceFilter, string ProvinceFilterMode, string RSAFilter, string RSAFilterMode, int userId, string group)
        {
            ...
            if (group == "RSA")
            {
                filteredApps = filteredApps.Where(a => (a.GrantStatus == "Submitted by Online User" || a.GrantStatus == "Rejected after Full Assessment") && a.RSAId == userId);
            }

            if (group == "RM")
            {
                filteredApps = filteredApps.Where(a => a.GrantStatus == "RSA Review Completed" && a.RMId == userId);
            };
