...
{
    public abstract class CHIETAMISWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CHIETAMISWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CHIETAMISWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CHIETAMISDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CHIETAMISDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CHIETAMISDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CHIETAMISDbContext, Task<T>> func)
        {
            T result;
